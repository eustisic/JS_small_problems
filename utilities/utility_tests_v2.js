...
test("uniq is defined", function() {
  return typeof _().uniq === "function";
});

test("uniq returns a uniq array", function() {
  let testArray = [1, 1, 2, 2, 'a', 'a'];
  return _().uniq(testArray).length === 3;
});
